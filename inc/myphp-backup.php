...
class Backup_Database {
    ...
    public function __construct($host, $username, $passwd, $dbName, $charset = 'utf8') {
        ...
        $this->backupFile      = 'backup-'.$this->dbName.'-'.date("Y-m-d_His", time()).'.sql';
...
if ($result=="OK") {
    modal("سوپاس","بەسەرکەوتویی داتابەیس زەخیرەکرا.");
}else {
    modal("کێشەیەك ڕویدا","نەتواندرا داتابەیس پاشەکەوتبکرێت.");
}
  direct("index.php");
